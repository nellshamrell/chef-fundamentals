...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nellshamrell-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/nellshamrell"
  #   chef.validation_client_name = "nellshamrell-validator"
  #   chef.validation_key_path = ".chef/nellshamrell-validator.pem"
  # end
end
